...
export declare class Iamport {
     ...
     * @returns {Promise} result
     */
    getCertification(impUid: string): Promise<{}>;
    /**
     * SMS 본인인증 정보 삭제
     ...
     * @returns {Promise} result
     */
    deleteCertification(impUid: string): Promise<{}>;
    /**
     ...
     * @returns {Promise} result
     */
    findByImpUid(impUid: string): Promise<{}>;
    /**
     * 상점 고유 아이디로 결제 정보 조회
     ...
     * @returns {Promise} result
     */
    findByMerchantUid(merchantUid: string): Promise<{}>;
    /**
     ...
     * @returns {Promise} result
     */
    findAllByMerchantUid(merchantUid: string, extra?: any): Promise<{}>;
    /**
     * 결제 상태로 결제 정보 목록 조회
     ...
     * @returns {Promise} result
     */
    findAllByStatus(status?: string, extra?: any): Promise<{}>;
    /**
     * 결제취소
     ...
     * @returns {Promise} result
     */
    cancelByImpUid(impUid: string, extra?: any): Promise<{}>;
    /**
     * 상점 고유 아이디로 결제취소
     * POST - https://api.iamport.kr/payments/cancel
     * @see {@link https://api.iamport.kr/#!/payments/cancelPayment}
     ...
     * @returns {Promise} result
     */
    cancelByMerchantUid(merchantUid: string, extra?: any): Promise<{}>;
    /**
     * 결제예정금액 사전등록
     ...
     * @returns {Promise} result
     */
    createPreparedPayment(data?: any): Promise<{}>;
    /**
     * 사전등록된 결제정보 조회
     ...
     * @returns {Promise} result
     */
    getPreparedPayment(merchantUid: string): Promise<{}>;
    /**
     * 비인증 신용카드 결제요청
     ...
     * @returns {Promise} result
     */
    getSubscription(customerUid: string): Promise<{}>;
    /**
     * 구매자 빌링키 삭제
     ...
     * @returns {Promise} result
     */
    deleteSubscription(customerUid: string): Promise<{}>;
    /**
     * 가상계좌 발급
     ...
     * @returns {Promise} result
     */
    private _resSerializer;
    private _request;
    private _updateToken;
    private _validatePayment;
    private _isExpiredToken;
    private _haveNotRequiredParams;
}
